...
public class BoardPanel extends JPanel {
	 ...
	 * 
	 * PPC: [1,2], [1,3], [1,4,5], [1,4,6],[1,4,7],[1,4,8]
	 * Test cases =
	 * [
	 * type = Fruit
	 * type = SnakeBody
	 * type = SnakeHead, game.getDirection() = North;
	 * type = SnakeHead, game.getDirection() = South;
	 * type = SnakeHead, game.getDirection() = East;
	 * type = SnakeHead, game.getDirection() = West;
	 */
