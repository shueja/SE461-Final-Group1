...
public class Clock {
	 ...
	 * Node 1: isPaused: T->2, F->3
	 * Node 2: return true;
	 * node 3: return false;
	 * node 4: final
	 * 
	 * PPC: [1,2,4], [1,3,4]
	 * TR: isPaused = true, isPaused = false;
	 */
	public boolean isPaused() {
		return isPaused;
	}
	 ...
	 * 
	 * Node 1: elapsedCycles>0: T->2, F->3
	 * Node 2: elapsedCycles--; return true;
	 * node 3: return false;
	 * node 4: final
	 * 
	 * PPC: [1,2,4], [1,3,4]
	 * TR: elapsedCycles > 0, elapsedCycles <=0
	 */
